                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-divider">
                             ...
                             <li class="nav-item ">
                                <a class="nav-link" href="influencer-profile.html"><i class="fa fa-fw fa-user-circle"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{Request::segment(2) == 'post' || Request::segment(2) == 'kategori'  ? 'active' : ''}}" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-newspaper"></i>Posting</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        
                                        <li class="nav-item ">
                                            <a class="nav-link {{Request::segment(2) == 'post' ? 'active' : ''}}" href="{{route('post.index')}}">Postingan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{Request::segment(2) == 'kategori' ? 'active' : ''}}" href="{{route('kategori.index')}}">Kategori</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link {{Request::segment(2) == 'upload' ? 'active' : ''}}" href="{{route('upload.index')}}"><i class="fas fa-fw fa-upload"></i>Upload</a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link" href="pages/accordions.html"><i class="fas fa-fw fa-chart-area"></i>Views</a>
                            </li>
